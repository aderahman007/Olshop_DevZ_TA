...
class home extends CI_controller {
	...
	public function alert() {
		...
		$this->load->view('home/alert',$data);
	}
...
// 					$isi_psn ='Salam, DevZ Online Shop';


// 					$this->load->library('email');
// 					$this->email->set_mailtype('html');
// 					$this->email->from("devz@gmail.com", "Admin DevZ Online Shop");
// 					$this->email->to($email);
// 					$this->email->subject('Detail Pesanan/Belanja DevZ Online Shop');
...
// 					$this->email->send();
			...
			foreach($this->cart->contents() as $items)
						...
						<?php
						echo "<meta http-equiv='refresh' content='0; url=".base_url()."home/alert'>";
