...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>asset/package/dist/sweetalert2.min.css">
    <!--[if lt IE 9]>
...
<body>
					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							...
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo $gp;?>"><i class="fa fa-instagram"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							...
							?>
							<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>images/logo/<?php echo $logo;?>" alt="DevZ Online Shop" /></a>
						</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2014 DevZ Online Shop. All rights reserved.</p>
	...
	<script src="<?php echo base_url();?>asset/package/dist/sweetalert2.min.js"></script>
    ...
    <script type="text/javascript">
        $('#success').ready(function(){
            Swal.fire({
                ...
                html: 'Pesanan anda telah terkirim, kami akan segera memprosesnya dalam waktu 1x24 jam. Silahkan cek email anda beberapa saat lagi untuk melihat rincian detail pembayaran,<br> <b> Silahkan Konfirmasi Via Whatsapp ke No <h3 style="color: blue">+6282178309894</h3> atau yang tertera di kontak kami <b> <br><h3>Terima Kasih</h3>'
            }).then((result)=>{
                if(result.value){
                    Swal.fire({
                        position: 'top-end',
